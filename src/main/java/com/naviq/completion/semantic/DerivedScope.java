...
import com.naviq.completion.semantic.oracle.SemanticScope;
...
public interface DerivedScope {
    ...
    /**
     * Tên cột mà scope này PROJECT rDerivedScopea (SELECT list của chính nó) - chỉ chứa cột suy ra được tên
