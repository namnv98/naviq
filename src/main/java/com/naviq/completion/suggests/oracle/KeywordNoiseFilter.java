...
public class KeywordNoiseFilter {
     ...
     *                     tokenIndex.
     */
    public static Set<String> computeMatchedRuleNames(OracleSQLSyntacticAnalyzer.Result syn, int cursorOffset) {
        ...
        boolean rightAfterDot = lastReal != null && lastReal.getType() ==  PlSqlParser.PERIOD ;
