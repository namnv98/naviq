...
import com.naviq.completion.semantic.postgresql.SemanticScope;
...
public class DerivedColumnExpander {
     ...
     */
    public static void addDerivedColumns(List<Suggest> suggests, String alias, Scope derivedScope) {
