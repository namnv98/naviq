 ...
 * {@link com.naviq.completion.semantic.DanglingDotDetector}, phát hiện thuần túy qua TOKEN STREAM,
...
public class SemanticScope extends PlSqlParserBaseListener {
    ...
    public static class Scope implements DerivedScope {
     ...
     * {@code com.naviq.completion.semantic.DanglingDotDetector.detect(...)} (không làm trong lớp
